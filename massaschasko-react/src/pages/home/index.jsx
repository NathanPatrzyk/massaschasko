            ...
            page.slug == "pierogues" && (
              <LinkToProduct
                ...
                products={[
                  ...
                  "pieroguedebatataerepolho400g",
                  "pieroguedebatataerucula400g",
                  "pieroguedecalabresa400g",
                  "pieroguedeespinafrericotaebrocolis400g",
                  "pieroguedefeijaoebacon400g",
                  "pieroguedepizza400g",
                ]}
              />
            )
            ...
            page.slug == "nhoques" && (
              <LinkToProduct
                ...
                products={[
                  ...
                  "nhoquerecheadodefrango400g",
                  "nhoquerecheadodequeijo400g",
                  "nhoquetradicional400g",
                  "nhoquerecheadodecarnemoida400g",
                  "nhoquerecheadodefrango400g",
                  "nhoquerecheadodequeijo400g",
          ...
          (page) =>
            page.slug == "croissants" && (
              <LinkToProduct
                ...
                page={page}
                products={[
                  "croissantdecarnemoida350g",
                  "croissantdefrango350g",
                  "croissantdepizza350g",
                  "croissantdepalmito350g",
          ...
          (page) =>
            page.slug == "paes-de-queijo" && (
              <LinkToProduct
                ...
                page={page}
                products={[
                  "paodequeijocomcheddar500g",
                  "paodequeijocomvinagrete500g",
                  "paodequeijotradicional500g",
                  "paodequeijotradicional500g",
                  "paodequeijocomcheddar500g",
                  "paodequeijocomvinagrete500g",
                  "paodequeijocomvinagrete500g",
          ...
          (page) =>
            page.slug == "outros-produtos" && (
              <LinkToProduct
                ...
                page={page}
                products={[
                  "charutoderepolho400g",
                  "churrosdedocedeleitecomchocolate400g",
                  "coxinhadefrangoecatupiry400g",
                  "kiberecheado400g",
                  "macarraotalharim400g",
                  "hamburgao12kg",
                  "hotdog12kg",
                  "charutoderepolho400g",
                  "churrosdedocedeleitecomchocolate400g",
