...
VALUES
    ...
    ("Nhoque Tradicional", 4),
    ("Nhoque Recheado de Carne Moída", 4),
    ("Nhoque Recheado de Frango", 4),
    ("Nhoque Recheado de Queijo", 4),
    ("Nhoque Tradicional", 5),
    ("Nhoque de Espinafre", 5),
    ("Nhoque Recheado de Carne Moída", 5),
    ("Nhoque Recheado de Frango", 5),
    ("Nhoque Recheado de Queijo", 5),
    ("Croissant de Carne Moída", 6),
    ("Croissant de Frango", 6),
    ("Croissant de Pizza", 6),
    ("Croissant de Palmito", 6),
    ("Croissant de Banana com Canela", 6),
    ("Croissant de Chocolate Preto", 6),
    ("Croissant de Carne Moída", 7),
    ("Croissant de Frango", 7),
    ("Croissant de Pizza", 7),
    ("Croissant de Chocolate Preto", 7),
    ("Esfiha de Carne Moída", 8),
    ("Esfiha de Frango", 8),
    ("Esfiha de Pizza", 8),
    ("Esfiha de Palmito", 8),
    ("Esfiha de Costela", 8),
    ("Esfiha de Multigrãos", 8),
    ("Esfiha de Carne Moída", 9),
    ("Esfiha de Frango", 9),
    ("Esfiha Aberta de Carne Moída", 10),
    ("Esfiha Aberta de Frango", 10),
    ("Esfiha Aberta de Pizza", 10),
    ("Esfiha Aberta de Costela", 10),
    ("Esfiha Aberta de Chocolate Preto", 10),
